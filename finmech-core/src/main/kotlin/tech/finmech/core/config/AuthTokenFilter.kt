...
import tech.finmech.core.service.TokenService
import tech.finmech.core.service.UserDetailsServiceImpl

@Component
class AuthTokenFilter(
    private val userDetailsService: UserDetailsServiceImpl, private val tokenService: TokenService
    ...
    override fun doFilterInternal(
        ...
        val email = tokenService.extractUsername(jwtToken)
